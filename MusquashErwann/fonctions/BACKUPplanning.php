...
function planning(int $terrain, int $semaine, int $annee): string{
    ...
    //reservation terrain
    // $sqlRechercheTerrain = "SELECT horaire_planning_reservation, id_terrain FROM planning_reservation WHERE type_reservation = 'reservationTerrain' AND id_terrain = :idT;";
    ...
    try{
        ...
        if($nb_cours>0  ){ // || $nb_resTerrain>0
            ...
            //Array des crénaux pris par reserve
            ...
            for($i = 9; $i<20; $i++){
                ...
                for($y = 0; $y< 7; $y++){
                    ...
                    //     if($terrainR[0] == $i && $terrainR[1] == $y){
                    //         $resultat.='<td style="background-color: red;">TERRAIN RESERVE</td>';
                    //         $check=true;
                    //     }
                    // }
                        ...
                        if($coursSeul[1] == $i && $coursSeul[3]-1 == $y)
                        {
                            ...
                            if(($coursSeul[0] == "Cours adulte débutant" || $coursSeul[0] == "Cours adulte confirmé" || $coursSeul[0] == "Cours adulte expert") && $coursSeul[2] > 0){
                                if($coursSeul[5] == $groupeUtilisateur){
                                    ...
                                    $resultat.='<td rowspan="2" style="background-color: yellow;">'.$coursSeul[0].'<br>Places restantes : '.$coursSeul[2].
                                    '<br>
                                    ...
                                    $resultat.='<td rowspan="2" style="background-color: yellow;">'.$coursSeul[0].'<br>Places restantes : '.$coursSeul[2].'</td>';
                                }
                                //Rajouter l'heure précedente pour sauter une case
                                $heurePrecedente = $i+1;
                                $check=true;
                            ...
                            elseif(($coursSeul[0] == "Cours enfants Groupe 1" || $coursSeul[0] == "Cours enfants Groupe 2" || $coursSeul[0] == "Cours enfants Groupe 3") && $coursSeul[2] > 0){
                                ...
                                if($coursSeul[5] == $groupeUtilisateur){
                                    $resultat.='<td style="background-color: green;">'.$coursSeul[0].'<br>Places restantes : '.$coursSeul[2].
                                    //INPUT INSCRIPTION
                                    '
                                    ...
                                    $resultat.='<td style="background-color: green;">'.$coursSeul[0].'<br>Places restantes : '.$coursSeul[2].'</td>';
                                }
                    ...
                    if($check == true){
                        ...
                        <form action="reservations\reservationCoursColl.php" method="POST">
                        <input type="hidden" name="idTerrain" value="'.$terrain.'">
                            <input type="submit" value="S\'inscrire">
                        </form></td> ';
