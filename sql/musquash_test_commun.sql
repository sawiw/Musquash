...
--
-- Hôte : 127.0.0.1:3307
-- Généré le : sam. 09 avr. 2022 à 21:20
...
CREATE TABLE IF NOT EXISTS `utilisateur_cours_squash_collectif` (
  ...
  KEY `fk_cours_squash_collectif` (`id_cours_squash_collectif`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
...
CREATE TABLE IF NOT EXISTS `utilisateur_materiel_achat` (
  ...
  KEY `fk_utilisateur` (`id_utilisateur`),
  KEY `fk_materiel_achat` (`id_materiel_achat`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
...
CREATE TABLE IF NOT EXISTS `utilisateur_materiel_location` (
  ...
  KEY `fk_materiel_loaction` (`id_materiel_location`),
  KEY `fk_utilisateur` (`id_utilisateur`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
COMMIT;
